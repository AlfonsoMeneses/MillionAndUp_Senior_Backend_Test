...
/****** Object:  Database [BackendTest]    Script Date: 20/05/2023 4:51:58 p. m. ******/
CREATE DATABASE [BackendTest]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BackendTest', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\BackendTest.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'BackendTest_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\BackendTest_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [BackendTest] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [BackendTest] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [BackendTest] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [BackendTest] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [BackendTest] SET RECOVERY FULL 
GO
...
ALTER DATABASE [BackendTest] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [BackendTest] SET QUERY_STORE = ON
GO

ALTER DATABASE [BackendTest] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
